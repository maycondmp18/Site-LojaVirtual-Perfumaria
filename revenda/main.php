                ...
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <div class="main-menu f-right d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    <li><a href="../produtos.php">Produtos Essenza</a></li>
                                </ul>
                            </nav>
                        </div>          
                        <!-- Header-btn -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10">
                            ...
                            <div class="category-img text-center">
                                <a href="../index.php"> <img src="../assets/img/gallery/Home.png" alt=""></a>
                                <a href="essenza.php"> <img src="../assets/img/gallery/essenza.png" alt=""></a>
                                <a href="pedidos.php"> <img src="../assets/img/gallery/pedidos.png" alt=""></a>
                                <a href="meuMundo.php"> <img src="../assets/img/gallery/Meumundo.png" alt=""></a>
                                <a href="suporte.php"> <img src="../assets/img/gallery/suporte.png" alt=""></a>
                                <a href="perfil.php"> <img src="../assets/img/gallery/Perfil.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
